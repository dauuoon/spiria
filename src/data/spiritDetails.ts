...
export const SPIRIT_DETAIL_META: Record<string, SpiritDetailMeta> = {
	spirit_soyo: {
		...
		conversationLines: ['“아직 이루어지지 않았다고 사라진 건 아니야.”', '“오늘도 작은 소원 하나가 꽃잎에 내려앉았어.”', '“네 소원도 잠시 내가 간직해 줄까?”', '"지금 보는 별빛은 \n아주 오래전 별이 떠나보낸 빛이래."', '"꽃은 빛이 오는 방향을 천천히 찾아가. \n소원도 그럴지 몰라."', '"작은 꽃잎에도 빛을 받아들이는 \n저마다의 방법이 있어."'],
		craftCount: '미정',
		requestMatchRate: '94%',
		firstMetDate: '미정',
	},
