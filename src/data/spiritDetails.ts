...
export const SPIRIT_DETAIL_META: Record<string, SpiritDetailMeta> = {
	spirit_soyo: {
		...
		conversationLines: ['“아직 이루어지지 않았다고 사라진 건 아니야.”', '“오늘도 작은 소원 하나가 꽃잎에 내려앉았어.”', '“네 소원도 잠시 내가 간직해 줄까?”', '"지금 보는 별빛은 아주 오래전 별이 떠나보낸 빛이래."', '"꽃은 빛이 오는 방향을 천천히 찾아가. \n소원도 그럴지 몰라."', '"작은 꽃잎에도 빛을 받아들이는 \n저마다의 방법이 있어."'],
		craftCount: '미정',
		requestMatchRate: '94%',
		firstMetDate: '미정',
	},
	spirit_rua: {
		...
		conversationLines: ['“길을 잃었다면 잠시 멈춰 봐. \n잎이 흔들리는 쪽을 알려 줄게.”', '“바람이 지나간 길은 잎맥에 오래 남아 있어.”', '“천천히 걸어도 괜찮아. \n올바른 길은 사라지지 않으니까.”', '"잎맥은 물과 양분이 오가는 길이야. \n작은 잎 안에도 수많은 길이 있지."', '"바람은 보이지 않지만, \n흔들리는 잎을 보면 어디로 가는지 알 수 있어."', '"나무는 움직이지 않아도 \n빛과 바람을 따라 매일 조금씩 달라져."'],
		craftCount: '미정',
		requestMatchRate: '95%',
		firstMetDate: '미정',
	},
	spirit_tera: {
		...
		conversationLines: ['“아무것도 자라지 않는 것처럼 보여도, \n뿌리는 조용히 준비하고 있어.”', '“메마른 땅속에도 아직 작은 온기가 남아 있어.”', '“오늘은 네 마음에 어떤 꽃을 피워 볼까?”', '"씨앗은 아무것도 하지 않는 것처럼 보여도, \n땅속에서 깨어날 때를 기다려."', '"뿌리는 빛이 없는 곳에서도 물이 있는 방향을 찾아 자라."', '"메마른 땅도 물과 온기를 만나면 \n다시 생명을 품을 수 있어."'],
		craftCount: '미정',
		requestMatchRate: '93%',
		firstMetDate: '미정',
	},
	spirit_pleo: {
		...
		conversationLines: ['“길이 잘 보이지 않아도 괜찮아. \n내가 물결 위에 하나씩 놓아 줄게.”', '“물안개가 짙어지면 내 꼬리의 별빛을 따라와.”', '“멀리 보이지 않는 밤에는, \n바로 앞의 작은 빛만 따라가도 돼.”', '"달빛은 태양의 빛을 빌려 \n밤의 물결 위에 내려오는 거래."', '"잔잔한 물결도 빛을 \n조금씩 다른 방향으로 보내고 있어."', '"물은 낮은 곳을 향해 흐르면서도 \n결국 자신만의 길을 만들어."'],
		craftCount: '미정',
		requestMatchRate: '94%',
		firstMetDate: '미정',
	},
	spirit_porina: {
		...
		conversationLines: ['“오늘 네 마음에 좋은 향기가 머물렀으면 좋겠어.”', '“꽃향기는 사라지는 게 아니라 \n새로운 곳으로 여행하는 거야.”', '“바람에 흔들려도, \n네가 가진 향기까지 잃는 건 아니야.”', '"꽃향기는 아주 작은 분자가 \n바람을 타고 우리에게 도착한 거야."', '"향기는 눈에 보이지 않아도 \n멀리 있는 누군가에게 닿을 수 있어."', '"꽃마다 향기가 다른 건, \n자신을 기억하게 하는 방법이 다르기 때문일까?"'],
		craftCount: '미정',
		requestMatchRate: '95%',
		firstMetDate: '미정',
	},
	spirit_igni: {
		...
		conversationLines: ['“꺼진 줄 알았던 불씨도 가까이 보면 아직 따뜻해.”', '“조금 지쳤어? \n내가 네 곁에서 작은 온기를 지켜 줄게.”', '“다시 타오르기 위해 잠시 작아지는 불꽃도 있어.”', '"불꽃이 계속 타오르려면 \n열과 공기와 머물 곳이 모두 필요해."', '"재 속의 작은 불씨는 겉으로 보이지 않아도 \n오랫동안 온기를 품고 있어."', '"불은 가진 온기를 주변으로 나누면서 빛을 만들어."'],
		craftCount: '미정',
		requestMatchRate: '96%',
		firstMetDate: '미정',
	},
	spirit_nova: {
		...
		conversationLines: ['“전하지 못한 마음은 \n밤의 물결 위에서 계속 노래하고 있어.”', '“네가 하고 싶었던 말, 내가 별빛에 실어 보내 줄까?”', '“진심은 늦게 도착해도 결국 누군가의 마음에 닿아.”', '"목소리는 공기의 \n작은 떨림이 이어져 누군가에게 닿는 거래."', '"물결과 노래는 모두 떨림으로 멀리 마음을 전해."', '"아주 작은 소리도 \n조용한 밤에는 예상보다 멀리 갈 수 있어."'],
		craftCount: '미정',
		requestMatchRate: '95%',
		firstMetDate: '미정',
	},
	spirit_lumen: {
		...
		conversationLines: ['“흐려진 기억도 네 마음에 남긴 \n온기까지 사라지진 않아.”', '“잊었다고 생각한 장면도 \n빛을 비추면 다시 떠오를 수 있어.”', '“오늘 기억하고 싶은 순간이 있다면 내게 보여 줘.”', '"물 위의 빛은 물결이 \n움직일 때마다 새로운 모습으로 비쳐."', '"같은 별을 바라봐도 \n빛이 닿는 각도에 따라 다르게 보인대."', '"빛은 사라진 게 아니라, \n때로는 우리가 보지 못하는 방향으로 향하고 있어."'],
		craftCount: '미정',
		requestMatchRate: '95%',
		firstMetDate: '미정',
	},
	spirit_solaris: {
		...
		conversationLines: ['“추운 하루였지? 내가 조금 따뜻하게 밝혀 줄게.”', '“태양의 빛은 작은 결정 속에서도 오래 머물 수 있어.”', '“따뜻함은 크기보다 오래 지켜 주는 마음에서 생겨.”', '"식물은 햇빛을 받아 살아갈 \n에너지로 바꾸어 간직해."', '"결정은 빛을 통과시키면서 \n여러 방향으로 나누어 보내기도 해."', '"태양의 온기는 아주 먼 거리를 지나 \n오늘 네 곁까지 도착했어."'],
		craftCount: '미정',
		requestMatchRate: '94%',
		firstMetDate: '미정',
	},
	spirit_nubi: {
		...
		conversationLines: ['“사라지는 이야기는 \n내가 작은 결정에 새겨 두고 있어.”', '“잊고 싶지 않은 말이 있다면 천천히 들려줘.”', '“기록하지 못한 순간도 \n네 안에서는 의미를 잃지 않아.”', '"기록은 한 사람의 기억을 \n다른 시간까지 데려갈 수 있어."', '"오래된 글자가 남아 있다는 건 \n누군가의 생각이 아직 여기에 있다는 뜻이야."', '"작은 결정도 일정한 구조가 반복되며 \n단단한 형태를 만들어."'],
		craftCount: '미정',
		requestMatchRate: '94%',
		firstMetDate: '미정',
	},
	...
	spirit_orvis: {
		...
		conversationLines: ['“강하다는 건 무너지지 않는 게 아니라, \n다시 세우는 일이야.”', '“아주 작은 균열도 오래 두면 \n어둠이 스며들 수 있어.”', '“네가 지키고 싶은 것이 있다면 \n내 결정 곁에 맡겨 둬.”', '"결정은 작은 입자들이 \n질서를 이루며 아주 천천히 자라나."', '"단단한 돌에도 작은 틈은 있지만, \n그 틈이 빛이 들어오는 길이 되기도 해."', '"세상의 경계는 한 번에 만들어진 것이 아니라 \n작은 층이 쌓여 완성된 거야."'],
		craftCount: '미정',
		requestMatchRate: '98%',
		firstMetDate: '미정',
	},
