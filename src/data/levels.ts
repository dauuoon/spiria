...
const ranges: Array<{ from: number; to: number; exp: number; color: HexColor }> = [
  { from: 1, to: 9, exp: 30, color: '#B8BEC9' },
  { from: 10, to: 19, exp: 55, color: '#79D8C6' },
  { from: 20, to: 29, exp: 90, color: '#6EBEFF' },
  { from: 30, to: 39, exp: 145, color: '#8ED46B' },
  { from: 40, to: 49, exp: 210, color: '#E5C46B' },
  { from: 50, to: 59, exp: 305, color: '#A894FF' },
  { from: 60, to: 69, exp: 450, color: '#866BFF' },
  { from: 70, to: 79, exp: 650, color: '#6A46E8' },
  { from: 80, to: 89, exp: 900, color: '#4E5EEA' },
  { from: 90, to: 98, exp: 1250, color: '#F6E7A8' },
]
