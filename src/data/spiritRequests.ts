...
export const SPIRIT_REQUEST_PAGES: readonly SpiritRequestPage[] = [
  {
    ...
    tier: 'Easy',
    text: '밤하늘에 빌었던 아이들의 소원이 아침이 되면 모두 사라지고 있어요.\n작은 소원들을 반짝이는 꽃잎 속에 모아 오래 간직해 줄 정령이 필요해요.',
  },
  {
    id: 'req_spirit_rua',
    spiritId: 'spirit_rua',
    ...
    tier: 'Easy',
    text: '짙은 안개가 숲길을 뒤덮어 여행자들이 같은 자리를 맴돌고 있어요. \n흔들리는 잎과 하늘의 빛으로 안전한 길을 알려 줄 정령을 찾아 주세요.',
  },
  {
    id: 'req_spirit_tera',
    ...
    tier: 'Normal',
    text: '오랫동안 빛을 받지 못한 들판의 땅이 메말라 아무것도 자라지 않아요. \n굳은 땅을 깨우고 따뜻한 꽃을 피워 줄 정령이 필요해요.',
  },
  {
    id: 'req_spirit_pleo',
    ...
    tier: 'Easy',
    text: '밤마다 호수 위로 짙은 물안개가 번져 돌아오는 배들이 방향을 잃고 있어요. \n잔잔한 물결을 따라 달빛 길을 만들어 줄 정령을 찾아 주세요.',
  },
  {
    ...
    tier: 'Normal',
    text: '꽃이 피었지만 협곡의 거센 바람 때문에 향기가 마을까지 닿지 못하고 있어요. \n향기를 품고 반짝이는 바람길을 건너 줄 정령이 필요해요.',
  },
  {
    id: 'req_spirit_igni',
  ...
  },
  {
    ...
    tier: 'Normal',
    text: '호수 건너편으로 전하지 못한 노래가 밤마다 물결 위를 맴돌고 있어요. \n달빛을 타고 그 노래를 먼 곳까지 전해 줄 정령이 필요해요.',
  },
  {
    id: 'req_spirit_lumen',
    ...
    tier: 'Normal',
    text: '소중했던 기억이 오래된 호수의 그림자처럼 조금씩 흐려지고 있어요. \n어두운 밤에도 잊힌 장면을 밝게 비춰 줄 정령을 찾아 주세요.',
  },
  {
    ...
    tier: 'Hard',
    text: '긴 추위로 얼어붙은 마을에서는 아침이 와도 햇살의 온기를 느낄 수 없어요. \n차가운 얼음을 녹이고 잠든 생명을 깨워 줄 강한 빛의 정령이 필요해요.',
  },
  {
    id: 'req_spirit_nubi',
  ...
  },
  {
    ...
    tier: 'Hard',
    text: '한 노인이 가장 소중했던 사람의 얼굴을 조금씩 잊어가고 있어요. \n사라지는 기억을 고요한 물결 속에 담아 오래 지켜 줄 정령이 필요해요.',
  },
  {
    id: 'req_spirit_orvis',
